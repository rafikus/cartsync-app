...
export function Btn({
  ...
  return (
    ...
    >
      {loading ? (
        <ActivityIndicator
          color={variant === "primary" ? c.textOnAccent : c.accent}
          size={20}
        />
      ) : (
        <Text
          style={[
            styles.btnText,
            { color: variant === "primary" ? c.textOnAccent : c.text },
          ]}
        >
          {label}
        </Text>
...
export function Avatar({
  ...
  return (
    <Pressable
      onPress={onPress}
      style={[styles.avatar, { backgroundColor: c.avatarBg }]}
    >
      <Text style={[styles.avatarText, { color: c.avatarText }]}>
        {initials}
      </Text>
      <View
        style={[
          ...
          {
            borderColor: c.bgApp,
            backgroundColor: online ? c.syncLive : c.syncOffline,
          },
        ]}
      />
    </Pressable>
...
export function SyncIndicator({
  ...
  return (
    <View style={styles.syncRow}>
      <Animated.View
        style={[styles.syncDot, { backgroundColor: dotColor, opacity }]}
      />
